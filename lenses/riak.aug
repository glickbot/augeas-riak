module Riak =
    ...
    let elements0 = element dummy
    let elements1 = element elements0
    let elements2 = element elements1
    let elements3 = element elements2

    test elements3 get "{foo, bar}" = { "prop" = "foo"
    { "atom" = "bar" }
  }

    test elements3 get "[ { foo, bar } ]" = { "#list"
    { "prop" = "foo"
      { "atom" = "bar" }
    }
  }

    test elements3 get "[ { foo, [ { bar, \"b a z\" }, {a}, [ 5 ] ] } ]" =  { "#list"
    { "foo"
      { "prop" = "bar"
        { "str" = "b a z" }
      }
  ...
  test elements3 get "[ {foo, [{ bar, [{baz, [{bam, boom}]}]}]}]" = { "#list"
    { "foo"
      { "bar"
        { "baz"
          { "prop" = "bam"
